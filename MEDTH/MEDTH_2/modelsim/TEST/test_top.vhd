...
-- Secuencia de estimulos
  ...
  begin
    ...
    wait for 10*Tclk;
    wait until clk'event and clk = '1';
	report "(*) Funcionamiento por defecto: los displays muestran el reloj (modo 0)";
    -- Funcionamiento por defecto: los displays muestran el reloj (modo 0)

    wait for 500 us;
    wait until clk'event and clk = '1';
	
    report "(*) Programacion del reloj (08 hs 09 min PM)";
	...
	report "(*) Programacion del reloj (05 hs 20 min AM)";
    ...
    report "(*) Programacion del reloj (11 hs 59 min AM)";
