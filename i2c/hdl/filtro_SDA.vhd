...
architecture rtl of filtro_SDA is
  ...
  signal SDA_aux1:    std_logic;  
  signal SDA_aux2:    std_logic;
  signal SDA_aux3:    std_logic;
  signal SDA_aux :    std_logic_vector(2 downto 0);
...
begin
  ...
  process(clk,nRst)
    ...
    if nRst = '0' then
      ...
      SDA_aux <= (SDA_in & SDA_aux(2 downto 1));
    end if;
  end process;

  SDA_T_0 <= To_X01(SDA_aux(0));                         -- SDA_in vale '0' o 'H'
