...
architecture rtl of filtro_SDA_100M is
  signal SDA_in_T:   std_logic_vector(6 downto 1);   -- Rango con referencias                --signal SDA_in_T:   std_logic_vector(6 downto 1);
...
process(clk, nRst)                                 -- flip-flop de sincronizacion 2, metaestable                            
  ...
  SDA_T_0 <= To_X01(reg3_SDA_T0);                     -- SDA_T_0 vale '0' o 'H'                           -- SDA_T_0 vale '0' o 'H'
